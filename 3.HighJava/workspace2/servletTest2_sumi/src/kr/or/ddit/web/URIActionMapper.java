...
// uri_mapping.properties파일에 설정된 uri에 맞는 Action객체를 구해와서 그 Action객체의 인스턴스를
// 생성해서 반환하는 역할을 수행하는 클래스
public class URIActionMapper {
	
	// uri_mapping.properties파일의 내용을 읽어와 uri값은 key값으로, action객체명은 value값으로 하는
	// Map객체를 생성한다.
